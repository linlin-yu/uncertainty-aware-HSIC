...
from GKDE_ood import tune_dbu_ood
import pandas as pd
...
report_parameters = ['data/ood_left_out_classes', 'model/model_name',
                     'model/uce_loss_weight', 'model/alpha_teacher_weight',
                     'model/reconstruction_reg_weight', 
                    #  'model/tv_alpha_reg_weight', 
                     'model/tv_vacuity_reg_weight',
                     'model/iteration_step',
                     'model/hidden_dim','training/lr', 'training/weight_decay']
...
# config['model']['alpha_teacher_weight'] = tune.grid_search([0.1, 0.01, 0.0001, 0.00001,  0])
# config['model']['reconstruction_reg_weight'] = 0
# config['model']['entropy_reg_weight'] = 0
...
config['training']['weight_decay'] = 0.00001
config['model']['alpha_teacher_weight'] = 0.0001

config['model']['reconstruction_reg_weight'] = tune.grid_search([1, 0.1, 0.01, 0.001, 0.0001, 0])
config['model']['entropy_reg_weight'] = 0
